				...
				function($scope, smartServices) {
						...
						try {
							if ($scope.departamento != null) {
								...
								var error = function(response) {
									$scope
											.mensaje(
													"Error Se produjo un error al momento de listar las ciudades",
													response.data);
									console.log(angular.toJson(response));
								}
								var sendObject = {
					...
					$scope.consultarEmpresa = function() {
						...
						try {
							if ($scope.sw != false) {
								...
								var error = function(response) {
									...
									$scope
											.mensaje(
													"Error",
													"Ha ocurrido un error al consultar la empresa",
													reponsoObject);
								}
							...
							$scope
									.mensaje(
											"Error",
											"Ha ocurrido un error al momento de consultar la empresa",
											error.message);
						}
					}
					...
					$scope.grabarEmpresa = function() {
						try {
							...
							$scope
									.mensaje(
											"Error Ha ocurrido un error al momento de grabar la empresa",
											error.message);
						}
